...
__global__ void triad(double* A, double* B, double* C, double c, int n) {
    ...
    uint64_t actual_runtime = stop - start;
...
int main(int argc, char *argv[]) {
    ...
    triad<<<1,1>>>(device_A, device_B, device_C, 0.5, ARRAY_ELEMENTS);
